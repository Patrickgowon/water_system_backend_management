        ...
        <body style="margin:0;padding:0;background:#f0fdf4;font-family:Arial,sans-serif">
          <div style="max-width:600px;margin:0 auto;background:white;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.1)">
            ...
            <div style="padding:32px 24px">
              ...
              <p style="color:#374151;margin:0 0 24px">Hi <strong>${studentName}</strong>, your water request has been approved.</p>
              ...
              <p style="color:#6b7280;font-size:13px;margin:0">If you have any questions, please contact the admin.</p>
            </div>
        ...
        <body style="margin:0;padding:0;background:#f0fdf4;font-family:Arial,sans-serif">
          <div style="max-width:600px;margin:0 auto;background:white;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.1)">
            ...
            <div style="padding:32px 24px">
              ...
              <p style="color:#374151;margin:0 0 24px">Hi <strong>${driverName}</strong>, you have a new delivery assignment.</p>
              <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:20px;margin-bottom:24px">
                <table style="width:100%;border-collapse:collapse">
                  <tr><td style="padding:6px 0;color:#6b7280;font-size:14px">Order ID</td><td style="padding:6px 0;font-weight:bold;color:#111827;font-size:14px">#${orderId?.slice(-6).toUpperCase()}</td></tr>
